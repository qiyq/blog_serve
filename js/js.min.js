$(document).ready(function () {
    Array.prototype.forEach.call(document.querySelectorAll(".mdl-card__media"), function (a) {
...
$(window).scroll(function (c) {
    ...
    var b = $(".mdl-mini-footer").offset().top;
    var d = $(window).height();
    if (a > b - d + 42) {
...
function MaterialButton(a) {
    this.element_ = a, this.init()
}
function MaterialCheckbox(a) {
    this.element_ = a, this.init()
}
function MaterialIconToggle(a) {
    this.element_ = a, this.init()
}
function MaterialMenu(a) {
    this.element_ = a, this.init()
}
function MaterialProgress(a) {
    this.element_ = a, this.init()
}
function MaterialRadio(a) {
    this.element_ = a, this.init()
}
function MaterialSlider(a) {
    this.element_ = a, this.isIE_ = window.navigator.msPointerEnabled, this.init()
}
function MaterialSpinner(a) {
    this.element_ = a, this.init()
}
function MaterialSwitch(a) {
    this.element_ = a, this.init()
}
function MaterialTabs(a) {
    this.element_ = a, this.init()
}
function MaterialTab(d, b) {
    if (d) {
        if (b.element_.classList.contains(b.CssClasses_.MDL_JS_RIPPLE_EFFECT)) {
            ...
            a.classList.add(b.CssClasses_.MDL_RIPPLE), c.appendChild(a), d.appendChild(c)
        }
        d.addEventListener("click", function (f) {
            f.preventDefault();
            var e = d.href.split("#")[1], g = b.element_.querySelector("#" + e);
            b.resetTabState_(), b.resetPanelState_(), d.classList.add(b.CssClasses_.ACTIVE_CLASS), g.classList.add(b.CssClasses_.ACTIVE_CLASS)
        })
    }
}
function MaterialTextfield(a) {
    this.element_ = a, this.maxRows = this.Constant_.NO_MAX_ROWS, this.init()
}
function MaterialTooltip(a) {
    this.element_ = a, this.init()
}
function MaterialLayout(a) {
    this.element_ = a, this.init()
}
function MaterialLayoutTab(g, d, f, c) {
    if (g) {
        if (c.tabBar_.classList.contains(c.CssClasses_.JS_RIPPLE_EFFECT)) {
            var h = document.createElement("span");
            h.classList.add(c.CssClasses_.RIPPLE_CONTAINER), h.classList.add(c.CssClasses_.JS_RIPPLE_EFFECT);
            var b = document.createElement("span");
            b.classList.add(c.CssClasses_.RIPPLE), h.appendChild(b), g.appendChild(h)
        }
        g.addEventListener("click", function (j) {
            j.preventDefault();
            var i = g.href.split("#")[1], e = c.content_.querySelector("#" + i);
            c.resetTabState_(d), c.resetPanelState_(f), g.classList.add(c.CssClasses_.IS_ACTIVE), e.classList.add(c.CssClasses_.IS_ACTIVE)
        })
    }
}
function MaterialDataTable(a) {
    this.element_ = a, this.init()
}
function MaterialRipple(a) {
    this.element_ = a, this.init()
}
var componentHandler = function () {
    ...
    function D(c) {
        var a = c.getAttribute("data-upgraded");
    ...
    function q(h, i) {
        if (void 0 === h && void 0 === i) {
            ...
            for (var u = document.querySelectorAll("." + i), p = 0; p < u.length; p++) {
                k(u[p], c)
            }
        }
    }
    ...
    function k(F, t) {
        if (!("object" == typeof F && F instanceof Element)) {
        ...
        if (t) {
            ...
            y.forEach(function (a) {
                c.contains(a.cssClass) && -1 === C.indexOf(a) && !E(F, a.className) && C.push(a)
            })
        }
        for (var s, H = 0, J = C.length; J > H; H++) {
            if (s = C[H], !s) {
                throw new Error("Unable to find a registered component for the given class.")
            }
            I.push(s.className), F.setAttribute("data-upgraded", I.join(","));
            var G = new s.classConstructor(F);
            G[f] = s, B.push(G);
            for (var e = 0, K = s.callbacks.length; K > e; e++) {
                s.callbacks[e](F)
            }
            s.widget && (F[s.className] = G);
            var u = document.createEvent("Events");
            u.initEvent("mdl-componentupgraded", !0, !0), F.dispatchEvent(u)
        }
    }

    function z(h) {
        Array.isArray(h) || (h = "function" == typeof h.item ? Array.prototype.slice.call(h) : [h]);
        for (var c, d = 0, a = h.length; a > d; d++) {
            c = h[d], c instanceof HTMLElement && (c.children.length > 0 && z(c.children), k(c))
        }
    }

    function m(c) {
        var d = {
            classConstructor: c.constructor,
            className: c.classAsString,
            cssClass: c.cssClass,
            widget: void 0 === c.widget ? !0 : c.widget,
            callbacks: []
        };
        if (y.forEach(function (h) {
                if (h.cssClass === d.cssClass) {
                    throw new Error("The provided cssClass has already been registered.")
                }
                if (h.className === d.className) {
                    throw new Error("The provided className has already been registered")
                }
            }), c.constructor.prototype.hasOwnProperty(f)) {
            throw new Error("MDL component classes must not have " + f + " defined as a property.")
        }
        var a = w(c.classAsString, d);
        a || y.push(d)
    }

    function b(c, d) {
        var a = w(c);
        a && a.callbacks.push(d)
    }
    ...
    function A(h) {
        if (h && h[f].classConstructor.prototype.hasOwnProperty(g)) {
            h[g]();
            var c = B.indexOf(h);
            B.splice(c, 1);
            var d = h.element_.getAttribute("data-upgraded").split(","), a = d.indexOf(h[f].classAsString);
            d.splice(a, 1), h.element_.setAttribute("data-upgraded", d.join(","));
            var l = document.createEvent("Events");
            l.initEvent("mdl-componentdowngraded", !0, !0), h.element_.dispatchEvent(l)
        }
    }
    ...
    var y = [], B = [], g = "mdlDowngrade_", f = "mdlComponentConfigInternal_";
    return {
        upgradeDom: q,
        upgradeElement: k,
        upgradeElements: z,
        upgradeAllRegistered: j,
        registerUpgradedCallback: b,
        register: m,
        downgradeElements: v
    }
}();
window.addEventListener("load", function () {
    ...
    for (var d = ["webkit", "moz"], b = 0; b < d.length && !window.requestAnimationFrame; ++b) {
        var c = d[b];
    ...
    if (/iP(ad|hone|od).*OS 6/.test(window.navigator.userAgent) || !window.requestAnimationFrame || !window.cancelAnimationFrame) {
        ...
        window.requestAnimationFrame = function (h) {
            var f = Date.now(), g = Math.max(a + 16, f);
    ...
    RIPPLE: "mdl-ripple"
}, MaterialButton.prototype.blurHandler = function (a) {
    ...
    if (this.element_) {
        if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
            var a = document.createElement("span");
            a.classList.add(this.CssClasses_.RIPPLE_CONTAINER), this.rippleElement_ = document.createElement("span"), this.rippleElement_.classList.add(this.CssClasses_.RIPPLE), a.appendChild(this.rippleElement_), this.boundRippleBlurHandler = this.blurHandler.bind(this), this.rippleElement_.addEventListener("mouseup", this.boundRippleBlurHandler), this.element_.appendChild(a)
        }
    ...
    widget: !0
}), MaterialCheckbox.prototype.Constant_ = {TINY_TIMEOUT: 0.001}, MaterialCheckbox.prototype.CssClasses_ = {
...
}, MaterialCheckbox.prototype.onChange_ = function (a) {
    this.updateClasses_()
}, MaterialCheckbox.prototype.onFocus_ = function (a) {
    this.element_.classList.add(this.CssClasses_.IS_FOCUSED)
}, MaterialCheckbox.prototype.onBlur_ = function (a) {
    this.element_.classList.remove(this.CssClasses_.IS_FOCUSED)
}, MaterialCheckbox.prototype.onMouseUp_ = function (a) {
    this.blur_()
}, MaterialCheckbox.prototype.updateClasses_ = function () {
    this.checkDisabled(), this.checkToggleState()
}, MaterialCheckbox.prototype.blur_ = function (a) {
    ...
    if (this.element_) {
        ...
        d.classList.add(this.CssClasses_.BOX_OUTLINE);
        var b = document.createElement("span");
        b.classList.add(this.CssClasses_.FOCUS_HELPER);
        var c = document.createElement("span");
        if (c.classList.add(this.CssClasses_.TICK_OUTLINE), d.appendChild(c), this.element_.appendChild(b), this.element_.appendChild(d), this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
    ...
    widget: !0
}), MaterialIconToggle.prototype.Constant_ = {TINY_TIMEOUT: 0.001}, MaterialIconToggle.prototype.CssClasses_ = {
    ...
    IS_DISABLED: "is-disabled",
    IS_CHECKED: "is-checked"
}, MaterialIconToggle.prototype.onChange_ = function (a) {
    this.updateClasses_()
}, MaterialIconToggle.prototype.onFocus_ = function (a) {
    this.element_.classList.add(this.CssClasses_.IS_FOCUSED)
}, MaterialIconToggle.prototype.onBlur_ = function (a) {
    this.element_.classList.remove(this.CssClasses_.IS_FOCUSED)
}, MaterialIconToggle.prototype.onMouseUp_ = function (a) {
    this.blur_()
}, MaterialIconToggle.prototype.updateClasses_ = function () {
    this.checkDisabled(), this.checkToggleState()
}, MaterialIconToggle.prototype.blur_ = function (a) {
    window.setTimeout(function () {
        this.inputElement_.blur()
    }.bind(this), this.Constant_.TINY_TIMEOUT)
    ...
    if (this.element_) {
        ...
        h.classList.add(this.CssClasses_.CONTAINER), this.element_.parentElement.insertBefore(h, this.element_), this.element_.parentElement.removeChild(this.element_), h.appendChild(this.element_), this.container_ = h;
        var k = document.createElement("div");
        k.classList.add(this.CssClasses_.OUTLINE), this.outline_ = k, h.insertBefore(k, this.element_);
        var m = this.element_.getAttribute("for"), g = null;
        m && (g = document.getElementById(m), g && (this.forElement_ = g, g.addEventListener("click", this.handleForClick_.bind(this)), g.addEventListener("keydown", this.handleForKeyboardEvent_.bind(this))));
        for (var d = this.element_.querySelectorAll("." + this.CssClasses_.ITEM), j = 0; j < d.length; j++) {
            d[j].addEventListener("click", this.handleItemClick_.bind(this)), d[j].tabIndex = "-1", d[j].addEventListener("keydown", this.handleItemKeyboardEvent_.bind(this))
        }
        if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
            for (this.element_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS), j = 0; j < d.length; j++) {
                var f = d[j], b = document.createElement("span");
                b.classList.add(this.CssClasses_.ITEM_RIPPLE_CONTAINER);
                var c = document.createElement("span");
                c.classList.add(this.CssClasses_.RIPPLE), b.appendChild(c), f.appendChild(b), f.classList.add(this.CssClasses_.RIPPLE_EFFECT)
            }
        }
        this.element_.classList.contains(this.CssClasses_.BOTTOM_LEFT) && this.outline_.classList.add(this.CssClasses_.BOTTOM_LEFT), this.element_.classList.contains(this.CssClasses_.BOTTOM_RIGHT) && this.outline_.classList.add(this.CssClasses_.BOTTOM_RIGHT), this.element_.classList.contains(this.CssClasses_.TOP_LEFT) && this.outline_.classList.add(this.CssClasses_.TOP_LEFT), this.element_.classList.contains(this.CssClasses_.TOP_RIGHT) && this.outline_.classList.add(this.CssClasses_.TOP_RIGHT), this.element_.classList.contains(this.CssClasses_.UNALIGNED) && this.outline_.classList.add(this.CssClasses_.UNALIGNED), h.classList.add(this.CssClasses_.IS_UPGRADED)
    }
}, MaterialMenu.prototype.handleForClick_ = function (c) {
    if (this.element_ && this.forElement_) {
        var a = this.forElement_.getBoundingClientRect(), b = this.forElement_.parentElement.getBoundingClientRect();
    ...
    this.toggle(c)
}, MaterialMenu.prototype.handleForKeyboardEvent_ = function (b) {
    if (this.element_ && this.container_ && this.forElement_) {
        var a = this.element_.querySelectorAll("." + this.CssClasses_.ITEM + ":not([disabled])");
...
}, MaterialMenu.prototype.handleItemKeyboardEvent_ = function (d) {
    if (this.element_ && this.container_) {
        ...
        if (b && b.length > 0 && this.container_.classList.contains(this.CssClasses_.IS_VISIBLE)) {
            var c = Array.prototype.slice.call(b).indexOf(d.target);
            if (d.keyCode === this.Keycodes_.UP_ARROW) {
                d.preventDefault(), c > 0 ? b[c - 1].focus() : b[b.length - 1].focus()
            } else {
                if (d.keyCode === this.Keycodes_.DOWN_ARROW) {
                    d.preventDefault(), b.length > c + 1 ? b[c + 1].focus() : b[0].focus()
                } else {
                    if (d.keyCode === this.Keycodes_.SPACE || d.keyCode === this.Keycodes_.ENTER) {
                        d.preventDefault();
                        var a = new MouseEvent("mousedown");
                        d.target.dispatchEvent(a), a = new MouseEvent("mouseup"), d.target.dispatchEvent(a), d.target.click()
                    } else {
                        d.keyCode === this.Keycodes_.ESCAPE && (d.preventDefault(), this.hide())
                    }
                }
            }
        }
    }
}, MaterialMenu.prototype.handleItemClick_ = function (a) {
    null !== a.target.getAttribute("disabled") ? a.stopPropagation() : (this.closing_ = !0, window.setTimeout(function (b) {
        this.hide(), this.closing_ = !1
    }.bind(this), this.Constant_.CLOSE_TIMEOUT))
}, MaterialMenu.prototype.applyClip_ = function (b, a) {
    this.element_.style.clip = this.element_.classList.contains(this.CssClasses_.UNALIGNED) ? null : this.element_.classList.contains(this.CssClasses_.BOTTOM_RIGHT) ? "rect(0 " + a + "px 0 " + a + "px)" : this.element_.classList.contains(this.CssClasses_.TOP_LEFT) ? "rect(" + b + "px 0 " + b + "px 0)" : this.element_.classList.contains(this.CssClasses_.TOP_RIGHT) ? "rect(" + b + "px " + a + "px " + b + "px " + a + "px)" : null
}, MaterialMenu.prototype.addAnimationEndListener_ = function () {
    var a = function () {
        this.element_.removeEventListener("transitionend", a), this.element_.removeEventListener("webkitTransitionEnd", a), this.element_.classList.remove(this.CssClasses_.IS_ANIMATING)
    }.bind(this);
    this.element_.addEventListener("transitionend", a), this.element_.addEventListener("webkitTransitionEnd", a)
}, MaterialMenu.prototype.show = function (j) {
    if (this.element_ && this.container_ && this.outline_) {
        var f = this.element_.getBoundingClientRect().height, g = this.element_.getBoundingClientRect().width;
        this.container_.style.width = g + "px", this.container_.style.height = f + "px", this.outline_.style.width = g + "px", this.outline_.style.height = f + "px";
        for (var d = this.Constant_.TRANSITION_DURATION_SECONDS * this.Constant_.TRANSITION_DURATION_FRACTION, k = this.element_.querySelectorAll("." + this.CssClasses_.ITEM), c = 0; c < k.length; c++) {
            var b = null;
            b = this.element_.classList.contains(this.CssClasses_.TOP_LEFT) || this.element_.classList.contains(this.CssClasses_.TOP_RIGHT) ? (f - k[c].offsetTop - k[c].offsetHeight) / f * d + "s" : k[c].offsetTop / f * d + "s", k[c].style.transitionDelay = b
        }
        this.applyClip_(f, g), window.requestAnimationFrame(function () {
            this.element_.classList.add(this.CssClasses_.IS_ANIMATING), this.element_.style.clip = "rect(0 " + g + "px " + f + "px 0)", this.container_.classList.add(this.CssClasses_.IS_VISIBLE)
        }.bind(this)), this.addAnimationEndListener_();
        var h = function (a) {
            a === j || this.closing_ || (document.removeEventListener("click", h), this.hide())
        }.bind(this);
        document.addEventListener("click", h)
    }
}, MaterialMenu.prototype.hide = function () {
    if (this.element_ && this.container_ && this.outline_) {
        for (var d = this.element_.querySelectorAll("." + this.CssClasses_.ITEM), b = 0; b < d.length; b++) {
            d[b].style.transitionDelay = null
        }
        var c = this.element_.getBoundingClientRect().height, a = this.element_.getBoundingClientRect().width;
        this.element_.classList.add(this.CssClasses_.IS_ANIMATING), this.applyClip_(c, a), this.container_.classList.remove(this.CssClasses_.IS_VISIBLE), this.addAnimationEndListener_()
    }
}, MaterialMenu.prototype.toggle = function (a) {
    ...
    widget: !0
}), MaterialProgress.prototype.Constant_ = {}, MaterialProgress.prototype.CssClasses_ = {INDETERMINATE_CLASS: "mdl-progress__indeterminate"}, MaterialProgress.prototype.setProgress = function (a) {
    this.element_.classList.contains(this.CssClasses_.INDETERMINATE_CLASS) || (this.progressbar_.style.width = a + "%")
}, MaterialProgress.prototype.setBuffer = function (a) {
    ...
    widget: !0
}), MaterialRadio.prototype.Constant_ = {TINY_TIMEOUT: 0.001}, MaterialRadio.prototype.CssClasses_ = {
    IS_FOCUSED: "is-focused",
    IS_DISABLED: "is-disabled",
    IS_CHECKED: "is-checked",
    IS_UPGRADED: "is-upgraded",
    ...
    RIPPLE_CENTER: "mdl-ripple--center",
    RIPPLE: "mdl-ripple"
}, MaterialRadio.prototype.onChange_ = function (d) {
    for (var b = document.getElementsByClassName(this.CssClasses_.JS_RADIO), c = 0; c < b.length; c++) {
        var a = b[c].querySelector("." + this.CssClasses_.RADIO_BTN);
        a.getAttribute("name") === this.btnElement_.getAttribute("name") && b[c].MaterialRadio.updateClasses_()
    }
}, MaterialRadio.prototype.onFocus_ = function (a) {
    this.element_.classList.add(this.CssClasses_.IS_FOCUSED)
}, MaterialRadio.prototype.onBlur_ = function (a) {
    this.element_.classList.remove(this.CssClasses_.IS_FOCUSED)
}, MaterialRadio.prototype.onMouseup_ = function (a) {
    this.blur_()
}, MaterialRadio.prototype.updateClasses_ = function () {
    this.checkDisabled(), this.checkToggleState()
}, MaterialRadio.prototype.blur_ = function (a) {
    window.setTimeout(function () {
    ...
    if (this.element_) {
        ...
        var d = document.createElement("span");
        d.classList.add(this.CssClasses_.RADIO_OUTER_CIRCLE);
        var b = document.createElement("span");
        b.classList.add(this.CssClasses_.RADIO_INNER_CIRCLE), this.element_.appendChild(d), this.element_.appendChild(b);
        var c;
        if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
            this.element_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS), c = document.createElement("span"), c.classList.add(this.CssClasses_.RIPPLE_CONTAINER), c.classList.add(this.CssClasses_.RIPPLE_EFFECT), c.classList.add(this.CssClasses_.RIPPLE_CENTER), c.addEventListener("mouseup", this.onMouseup_.bind(this));
            var a = document.createElement("span");
            a.classList.add(this.CssClasses_.RIPPLE), c.appendChild(a), this.element_.appendChild(c)
        }
    ...
    IS_UPGRADED: "is-upgraded"
}, MaterialSlider.prototype.onInput_ = function (a) {
    this.updateValueStyles_()
}, MaterialSlider.prototype.onChange_ = function (a) {
    this.updateValueStyles_()
}, MaterialSlider.prototype.onMouseUp_ = function (a) {
    a.target.blur()
}, MaterialSlider.prototype.onContainerMouseDown_ = function (b) {
    if (b.target === this.element_.parentElement) {
        b.preventDefault();
        var a = new MouseEvent("mousedown", {
            target: b.target,
            buttons: b.buttons,
        ...
        this.element_.dispatchEvent(a)
    }
}, MaterialSlider.prototype.updateValueStyles_ = function (b) {
    ...
    this.element_.disabled = !1
}, MaterialSlider.prototype.change = function (a) {
    a && (this.element_.value = a), this.updateValueStyles_()
}, MaterialSlider.prototype.init = function () {
    if (this.element_) {
        if (this.isIE_) {
            var c = document.createElement("div");
            c.classList.add(this.CssClasses_.IE_CONTAINER), this.element_.parentElement.insertBefore(c, this.element_), this.element_.parentElement.removeChild(this.element_), c.appendChild(this.element_)
        } else {
            var a = document.createElement("div");
            a.classList.add(this.CssClasses_.SLIDER_CONTAINER), this.element_.parentElement.insertBefore(a, this.element_), this.element_.parentElement.removeChild(this.element_), a.appendChild(this.element_);
...
}, MaterialSpinner.prototype.createLayer = function (j) {
    var f = document.createElement("div");
    f.classList.add(this.CssClasses_.MDL_SPINNER_LAYER), f.classList.add(this.CssClasses_.MDL_SPINNER_LAYER + "-" + j);
    var g = document.createElement("div");
    g.classList.add(this.CssClasses_.MDL_SPINNER_CIRCLE_CLIPPER), g.classList.add(this.CssClasses_.MDL_SPINNER_LEFT);
    var d = document.createElement("div");
    d.classList.add(this.CssClasses_.MDL_SPINNER_GAP_PATCH);
    var k = document.createElement("div");
    k.classList.add(this.CssClasses_.MDL_SPINNER_CIRCLE_CLIPPER), k.classList.add(this.CssClasses_.MDL_SPINNER_RIGHT);
    for (var c = [g, d, k], b = 0; b < c.length; b++) {
        var h = document.createElement("div");
        h.classList.add(this.CssClasses_.MDL_SPINNER_CIRCLE), c[b].appendChild(h)
    }
    f.appendChild(g), f.appendChild(d), f.appendChild(k), this.element_.appendChild(f)
    ...
    if (this.element_) {
        for (var a = 1; a <= this.Constant_.MDL_SPINNER_LAYER_COUNT; a++) {
            this.createLayer(a)
        }
    ...
    widget: !0
}),MaterialSwitch.prototype.Constant_ = {TINY_TIMEOUT: 0.001},MaterialSwitch.prototype.CssClasses_ = {
    ...
    IS_DISABLED: "is-disabled",
    IS_CHECKED: "is-checked"
},MaterialSwitch.prototype.onChange_ = function (a) {
    this.updateClasses_()
},MaterialSwitch.prototype.onFocus_ = function (a) {
    this.element_.classList.add(this.CssClasses_.IS_FOCUSED)
},MaterialSwitch.prototype.onBlur_ = function (a) {
    this.element_.classList.remove(this.CssClasses_.IS_FOCUSED)
},MaterialSwitch.prototype.onMouseUp_ = function (a) {
    this.blur_()
},MaterialSwitch.prototype.updateClasses_ = function () {
    this.checkDisabled(), this.checkToggleState()
},MaterialSwitch.prototype.blur_ = function (a) {
    window.setTimeout(function () {
        this.inputElement_.blur()
    }.bind(this), this.Constant_.TINY_TIMEOUT)
    ...
    if (this.element_) {
        this.inputElement_ = this.element_.querySelector("." + this.CssClasses_.INPUT);
        var d = document.createElement("div");
        d.classList.add(this.CssClasses_.TRACK);
        var b = document.createElement("div");
        b.classList.add(this.CssClasses_.THUMB);
        var c = document.createElement("span");
        if (c.classList.add(this.CssClasses_.FOCUS_HELPER), b.appendChild(c), this.element_.appendChild(d), this.element_.appendChild(b), this.boundMouseUpHandler = this.onMouseUp_.bind(this), this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
...
},MaterialTabs.prototype.initTabs_ = function (b) {
    ...
    for (var a = 0; a < this.tabs_.length; a++) {
        new MaterialTab(this.tabs_[a], this)
    }
    this.element_.classList.add(this.CssClasses_.UPGRADED_CLASS)
},MaterialTabs.prototype.resetTabState_ = function () {
    for (var a = 0; a < this.tabs_.length; a++) {
        this.tabs_[a].classList.remove(this.CssClasses_.ACTIVE_CLASS)
    }
},MaterialTabs.prototype.resetPanelState_ = function () {
    for (var a = 0; a < this.panels_.length; a++) {
        this.panels_[a].classList.remove(this.CssClasses_.ACTIVE_CLASS)
    }
    ...
    IS_UPGRADED: "is-upgraded"
},MaterialTextfield.prototype.onKeyDown_ = function (b) {
    var a = b.target.value.split("\n").length;
    13 === b.keyCode && a >= this.maxRows && b.preventDefault()
},MaterialTextfield.prototype.onFocus_ = function (a) {
    this.element_.classList.add(this.CssClasses_.IS_FOCUSED)
},MaterialTextfield.prototype.onBlur_ = function (a) {
    this.element_.classList.remove(this.CssClasses_.IS_FOCUSED)
...
},MaterialTextfield.prototype.change = function (a) {
    a && (this.input_.value = a), this.updateClasses_()
    ...
    widget: !0
}),MaterialTooltip.prototype.Constant_ = {},MaterialTooltip.prototype.CssClasses_ = {IS_ACTIVE: "is-active"},MaterialTooltip.prototype.handleMouseEnter_ = function (d) {
    d.stopPropagation();
    var b = d.target.getBoundingClientRect(), c = b.left + b.width / 2, a = -1 * (this.element_.offsetWidth / 2);
    0 > c + a ? (this.element_.style.left = 0, this.element_.style.marginLeft = 0) : (this.element_.style.left = c + "px", this.element_.style.marginLeft = a + "px"), this.element_.style.top = b.top + b.height + 10 + "px", this.element_.classList.add(this.CssClasses_.IS_ACTIVE), window.addEventListener("scroll", this.boundMouseLeaveHandler, !1), window.addEventListener("touchmove", this.boundMouseLeaveHandler, !1)
},MaterialTooltip.prototype.handleMouseLeave_ = function (a) {
    a.stopPropagation(), this.element_.classList.remove(this.CssClasses_.IS_ACTIVE), window.removeEventListener("scroll", this.boundMouseLeaveHandler), window.removeEventListener("touchmove", this.boundMouseLeaveHandler, !1)
},MaterialTooltip.prototype.init = function () {
    if (this.element_) {
        var a = this.element_.getAttribute("for");
        a && (this.forElement_ = document.getElementById(a)), this.forElement_ && (this.forElement_.getAttribute("tabindex") || this.forElement_.setAttribute("tabindex", "0"), this.boundMouseEnterHandler = this.handleMouseEnter_.bind(this), this.boundMouseLeaveHandler = this.handleMouseLeave_.bind(this), this.forElement_.addEventListener("mouseenter", this.boundMouseEnterHandler, !1), this.forElement_.addEventListener("click", this.boundMouseEnterHandler, !1), this.forElement_.addEventListener("blur", this.boundMouseLeaveHandler), this.forElement_.addEventListener("touchstart", this.boundMouseEnterHandler, !1), this.forElement_.addEventListener("mouseleave", this.boundMouseLeaveHandler))
    }
...
},MaterialLayout.prototype.resetTabState_ = function (b) {
    for (var a = 0; a < b.length; a++) {
        b[a].classList.remove(this.CssClasses_.IS_ACTIVE)
    }
},MaterialLayout.prototype.resetPanelState_ = function (b) {
    for (var a = 0; a < b.length; a++) {
        b[a].classList.remove(this.CssClasses_.IS_ACTIVE)
    }
    ...
    if (this.element_) {
        ...
        w.classList.add(this.CssClasses_.CONTAINER), this.element_.parentElement.insertBefore(w, this.element_), this.element_.parentElement.removeChild(this.element_), w.appendChild(this.element_);
        for (var D = this.element_.childNodes, G = 0; G < D.length; G++) {
            var q = D[G];
            q.classList && q.classList.contains(this.CssClasses_.HEADER) && (this.header_ = q), q.classList && q.classList.contains(this.CssClasses_.DRAWER) && (this.drawer_ = q), q.classList && q.classList.contains(this.CssClasses_.CONTENT) && (this.content_ = q)
        }
        this.header_ && (this.tabBar_ = this.header_.querySelector("." + this.CssClasses_.TAB_BAR));
        var k = this.Mode_.STANDARD;
        if (this.screenSizeMediaQuery_ = window.matchMedia(this.Constant_.MAX_WIDTH), this.screenSizeMediaQuery_.addListener(this.screenSizeHandler_.bind(this)), this.screenSizeHandler_(), this.header_ && (this.header_.classList.contains(this.CssClasses_.HEADER_SEAMED) ? k = this.Mode_.SEAMED : this.header_.classList.contains(this.CssClasses_.HEADER_WATERFALL) ? (k = this.Mode_.WATERFALL, this.header_.addEventListener("transitionend", this.headerTransitionEndHandler.bind(this)), this.header_.addEventListener("click", this.headerClickHandler.bind(this))) : this.header_.classList.contains(this.CssClasses_.HEADER_SCROLL) && (k = this.Mode_.SCROLL, w.classList.add(this.CssClasses_.HAS_SCROLLING_HEADER)), k === this.Mode_.STANDARD ? (this.header_.classList.add(this.CssClasses_.CASTING_SHADOW), this.tabBar_ && this.tabBar_.classList.add(this.CssClasses_.CASTING_SHADOW)) : k === this.Mode_.SEAMED || k === this.Mode_.SCROLL ? (this.header_.classList.remove(this.CssClasses_.CASTING_SHADOW), this.tabBar_ && this.tabBar_.classList.remove(this.CssClasses_.CASTING_SHADOW)) : k === this.Mode_.WATERFALL && (this.content_.addEventListener("scroll", this.contentScrollHandler_.bind(this)), this.contentScrollHandler_())), this.drawer_) {
            var z = document.createElement("div");
            z.classList.add(this.CssClasses_.DRAWER_BTN), this.drawer_.classList.contains(this.CssClasses_.ON_LARGE_SCREEN) ? z.classList.add(this.CssClasses_.ON_LARGE_SCREEN) : this.drawer_.classList.contains(this.CssClasses_.ON_SMALL_SCREEN) && z.classList.add(this.CssClasses_.ON_SMALL_SCREEN);
            var m = document.createElement("i");
            m.classList.add(this.CssClasses_.ICON), m.textContent = this.Constant_.MENU_ICON, z.appendChild(m), z.addEventListener("click", this.drawerToggleHandler_.bind(this)), this.element_.classList.add(this.CssClasses_.HAS_DRAWER), this.element_.classList.contains(this.CssClasses_.FIXED_HEADER) ? this.header_.insertBefore(z, this.header_.firstChild) : this.element_.insertBefore(z, this.content_);
            var b = document.createElement("div");
            b.classList.add(this.CssClasses_.OBFUSCATOR), this.element_.appendChild(b), b.addEventListener("click", this.drawerToggleHandler_.bind(this))
        }
        if (this.header_ && this.tabBar_) {
            this.element_.classList.add(this.CssClasses_.HAS_TABS);
            var j = document.createElement("div");
            j.classList.add(this.CssClasses_.TAB_CONTAINER), this.header_.insertBefore(j, this.tabBar_), this.header_.removeChild(this.tabBar_);
            var x = document.createElement("div");
            x.classList.add(this.CssClasses_.TAB_BAR_BUTTON), x.classList.add(this.CssClasses_.TAB_BAR_LEFT_BUTTON);
            var A = document.createElement("i");
            A.classList.add(this.CssClasses_.ICON), A.textContent = this.Constant_.CHEVRON_LEFT, x.appendChild(A), x.addEventListener("click", function () {
                this.tabBar_.scrollLeft -= this.Constant_.TAB_SCROLL_PIXELS
            }.bind(this));
            var v = document.createElement("div");
            v.classList.add(this.CssClasses_.TAB_BAR_BUTTON), v.classList.add(this.CssClasses_.TAB_BAR_RIGHT_BUTTON);
            var y = document.createElement("i");
            y.classList.add(this.CssClasses_.ICON), y.textContent = this.Constant_.CHEVRON_RIGHT, v.appendChild(y), v.addEventListener("click", function () {
                this.tabBar_.scrollLeft += this.Constant_.TAB_SCROLL_PIXELS
            }.bind(this)), j.appendChild(x), j.appendChild(this.tabBar_), j.appendChild(v);
            var B = function () {
                this.tabBar_.scrollLeft > 0 ? x.classList.add(this.CssClasses_.IS_ACTIVE) : x.classList.remove(this.CssClasses_.IS_ACTIVE), this.tabBar_.scrollLeft < this.tabBar_.scrollWidth - this.tabBar_.offsetWidth ? v.classList.add(this.CssClasses_.IS_ACTIVE) : v.classList.remove(this.CssClasses_.IS_ACTIVE)
            }.bind(this);
            this.tabBar_.addEventListener("scroll", B), B(), this.tabBar_.classList.contains(this.CssClasses_.JS_RIPPLE_EFFECT) && this.tabBar_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS);
            for (var g = this.tabBar_.querySelectorAll("." + this.CssClasses_.TAB), f = this.content_.querySelectorAll("." + this.CssClasses_.PANEL), F = 0; F < g.length; F++) {
                new MaterialLayoutTab(g[F], g, f, this)
            }
        }
    ...
    IS_UPGRADED: "is-upgraded"
},MaterialDataTable.prototype.selectRow_ = function (c, a, b) {
    return a ? function () {
        c.checked ? a.classList.add(this.CssClasses_.IS_SELECTED) : a.classList.remove(this.CssClasses_.IS_SELECTED)
    }.bind(this) : b ? function () {
        var e, d;
        if (c.checked) {
            for (e = 0; e < b.length; e++) {
                d = b[e].querySelector("td").querySelector(".mdl-checkbox"), d.MaterialCheckbox.check(), b[e].classList.add(this.CssClasses_.IS_SELECTED)
            }
        } else {
            for (e = 0; e < b.length; e++) {
                d = b[e].querySelector("td").querySelector(".mdl-checkbox"), d.MaterialCheckbox.uncheck(), b[e].classList.remove(this.CssClasses_.IS_SELECTED)
            }
        }
    }.bind(this) : void 0
},MaterialDataTable.prototype.createCheckbox_ = function (d, b) {
    var c = document.createElement("label");
    c.classList.add("mdl-checkbox"), c.classList.add("mdl-js-checkbox"), c.classList.add("mdl-js-ripple-effect"), c.classList.add("mdl-data-table__select");
    var a = document.createElement("input");
    return a.type = "checkbox", a.classList.add("mdl-checkbox__input"), d ? a.addEventListener("change", this.selectRow_(a, d)) : b && a.addEventListener("change", this.selectRow_(a, null, b)), c.appendChild(a), componentHandler.upgradeElement(c, "MaterialCheckbox"), c
},MaterialDataTable.prototype.init = function () {
    if (this.element_) {
        var j = this.element_.querySelector("th"), f = this.element_.querySelector("tbody").querySelectorAll("tr");
        if (this.element_.classList.contains(this.CssClasses_.SELECTABLE)) {
            var g = document.createElement("th"), d = this.createCheckbox_(null, f);
            g.appendChild(d), j.parentElement.insertBefore(g, j);
            for (var k = 0; k < f.length; k++) {
                var c = f[k].querySelector("td");
                if (c) {
                    var b = document.createElement("td"), h = this.createCheckbox_(f[k]);
                    b.appendChild(h), f[k].insertBefore(b, c)
                }
            }
        }
        this.element_.classList.add(this.CssClasses_.IS_UPGRADED)
    ...
    IS_ANIMATING: "is-animating",
    IS_VISIBLE: "is-visible"
},MaterialRipple.prototype.downHandler_ = function (j) {
    if (!this.rippleElement_.style.width && !this.rippleElement_.style.height) {
        var f = this.element_.getBoundingClientRect();
    ...
    if (this.rippleElement_.classList.add(this.CssClasses_.IS_VISIBLE), "mousedown" === j.type && this.ignoringMouseDown_) {
        this.ignoringMouseDown_ = !1
    } else {
        "touchstart" === j.type && (this.ignoringMouseDown_ = !0);
        var g = this.getFrameCount();
        if (g > 0) {
            return
        }
        this.setFrameCount(1);
        var d, k, c = j.currentTarget.getBoundingClientRect();
        if (0 === j.clientX && 0 === j.clientY) {
            d = Math.round(c.width / 2), k = Math.round(c.height / 2)
        } else {
            var b = j.clientX ? j.clientX : j.touches[0].clientX, h = j.clientY ? j.clientY : j.touches[0].clientY;
            d = Math.round(b - c.left), k = Math.round(h - c.top)
        }
        this.setRippleXY(d, k), this.setRippleStyles(!0), window.requestAnimationFrame(this.animFrameHandler.bind(this))
    }
},MaterialRipple.prototype.upHandler_ = function (a) {
    a && 2 !== a.detail && this.rippleElement_.classList.remove(this.CssClasses_.IS_VISIBLE)
    ...
    if (this.element_) {
        ...
        }, this.setFrameCount = function (b) {
            this.frameCount_ = b
        }, this.getRippleElement = function () {
            return this.rippleElement_
        }, this.setRippleXY = function (c, b) {
            this.x_ = c, this.y_ = b
        }, this.setRippleStyles = function (d) {
            if (null !== this.rippleElement_) {
                var e, c, f, b = "translate(" + this.x_ + "px, " + this.y_ + "px)";
...
+function (d) {
    ...
    h.VERSION = "3.2.0", h.DEFAULTS = {loadingText: "loading..."}, h.prototype.setState = function (a) {
    ...
    h.VERSION = "3.2.0", h.DEFAULTS = {interval: 5000, pause: "hover", wrap: !0}, h.prototype.keydown = function (b) {
        switch (b.which) {
            case 37:
                this.prev();
                break;
    ...
    h.VERSION = "3.2.0", h.DEFAULTS = {toggle: !0}, h.prototype.dimension = function () {
    ...
    function i(a) {
        a && 3 === a.which || (j(n).remove(), j(m).each(function () {
            var c = p(j(this)), b = {relatedTarget: this};
    ...
    h.VERSION = "3.2.0", h.DEFAULTS = {backdrop: !0, keyboard: !0, show: !0}, h.prototype.toggle = function (b) {
        return this.isShown ? this.hide() : this.show(b)
    }, h.prototype.show = function (a) {
        var j = this, i = f.Event("show.bs.modal", {relatedTarget: a});
    ...
    f.fn.modal = e, f.fn.modal.Constructor = h, f.fn.modal.noConflict = function () {
        ...
        var j = f(this), i = j.attr("href"), b = f(j.attr("data-target") || i && i.replace(/.*(?=#[^\s]+$)/, "")), a = b.data("bs.modal") ? "toggle" : f.extend({remote: !/#/.test(i) && i}, b.data(), j.data());
    ...
    h.VERSION = "3.2.0", h.prototype.show = function () {
        ...
        if (l || (l = a.attr("href"), l = l && l.replace(/.*(?=#[^\s]*$)/, "")), !a.parent("li").hasClass("active")) {
            var k = m.find(".active:last a")[0], j = f.Event("show.bs.tab", {relatedTarget: k});
...
$(document).ready(function () {
    var a = $(".sidebar-overlay");
    $(".sidebar-toggle").on("click", function () {
        var b = $("#sidebar");
        b.toggleClass("open");
        if (b.hasClass("sidebar-fixed-left") && b.hasClass("open")) {
            a.addClass("active");
...
$(document).ready(function () {
    var d = $("#sidebar");
    var a = $("#sidebar .sidebar-header");
    var c = a.css("background-image");
    var b = $(".sidebar-toggle");
    b.css("display", "initial");
    $("#sidebar-position").change(function () {
        var e = $(this).val();
        d.removeClass("sidebar-fixed-left").addClass(e).addClass("open");
        if (e == "sidebar-fixed-left") {
...
(function (a) {
    var b = a(".dropdown");
    b.on("show.bs.dropdown", function (c) {
        a(this).find(".dropdown-menu").first().stop(true, true).slideDown()
    });
    b.on("hide.bs.dropdown", function (c) {
        ...
        if (e && typeof e.test === "function") {
            for (var c = 0, b = this.length; c < b; c++) {
                ...
                if (d.nodeType === 1 && d.className) {
                    ...
                    d.className = jQuery.trim(f.join(" "))
                }
            }
        } else {
            a.call(this, e)
...
(function () {
    document.querySelector(".MD-burger-icon").addEventListener("click", function () {
        var a;
        a = this.childNodes[1].classList;
        if (a.contains("MD-burger-arrow")) {
            a.remove("MD-burger-arrow");
            a.add("MD-burger-line")
        } else {
            a.remove("MD-burger-line");
            a.add("MD-burger-arrow")
        }
    })
})();