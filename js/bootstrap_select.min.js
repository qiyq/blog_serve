        ...
        g.VERSION = "1.11.0", g.DEFAULTS = {
            ...
            constructor: g, init: function () {
                ...
                return this.$element.find("option").each(function (b) {
                    ...
                    if (h++, !c.hasClass("bs-title-option")) {
                        ...
                        if (c.data("content") || (l = o + '<span class="text">' + l + n + "</span>"), q && c.data("divider") !== !0) {
                            ...
                            if (0 === c.index()) {
                                f += 1;
                                var v = p[0].label, w = "undefined" != typeof p.data("subtext") ? '<small class="text-muted">' + p.data("subtext") + "</small>" : "", x = p.data("icon") ? '<span class="' + d.options.iconBase + " " + p.data("icon") + '"></span> ' : "";
                ...
                if (b || this.options.size !== !1 && !this.sizeInfo) {
                    ...
                    var o = h.offsetHeight, p = j ? j.offsetHeight : 0, q = k ? k.offsetHeight : 0, r = l ? l.offsetHeight : 0, s = m ? m.offsetHeight : 0, t = a(f).outerHeight(!0), u = "function" == typeof getComputedStyle ? getComputedStyle(d) : !1, v = u ? null : a(d), w = {
                ...
                this.$newElement.on("touchstart.dropdown", ".dropdown-menu", function (a) {
                    ...
                    var d = a(this), e = d.parent().data("originalIndex"), g = b.$element.val(), h = b.$element.prop("selectedIndex"), i = !0;
                    if (b.multiple && 1 !== b.options.maxOptions && c.stopPropagation(), c.preventDefault(), !b.isDisabled() && !d.parent().hasClass("disabled")) {
                        var j = b.$element.find("option"), k = j.eq(e), l = k.prop("selected"), m = k.parent("optgroup"), n = b.options.maxOptions, o = m.data("maxOptions") || !1;
                        if (b.multiple) {
