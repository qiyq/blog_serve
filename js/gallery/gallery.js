!function (e) {
    e.fn.navList = function () {
        ...
        return $a = t.find("a"), b = [], $a.each(function () {
            var t = e(this), a = Math.max(0, t.parents("li").length - 1), i = t.attr("href"), o = t.attr("target");
            b.push('<a class="link depth-' + a + '"' + ("undefined" != typeof o && "" != o ? ' target="' + o + '"' : "") + ("undefined" != typeof i && "" != i ? ' href="' + i + '"' : "") + '><span class="indent-' + a + '"></span>' + t.text() + "</a>")
        }), b.join("")
        ...
        var l, i = e(this), o = e("body"), n = e(window), r = i.attr("id");
        return l = e.extend({
            delay: 0,
            hideOnClick: !1,
            hideOnEscape: !1,
        ...
        }, t), "jQuery" != typeof l.target && (l.target = e(l.target)), i._hide = function (e) {
            l.target.hasClass(l.visibleClass) && (e && (e.preventDefault(), e.stopPropagation()), l.target.removeClass(l.visibleClass), window.setTimeout(function () {
                l.resetScroll && i.scrollTop(0), l.resetForms && i.find("form").each(function () {
                    this.reset()
                })
            }, l.delay))
        }, i.css("-ms-overflow-style", "-ms-autohiding-scrollbar").css("-webkit-overflow-scrolling", "touch"), l.hideOnClick && (i.find("a").css("-webkit-tap-highlight-color", "rgba(0,0,0,0)"), i.on("click", "a", function (t) {
            var a = e(this), o = a.attr("href"), n = a.attr("target");
            o && "#" != o && "" != o && o != "#" + r && (t.preventDefault(), t.stopPropagation(), i._hide(), window.setTimeout(function () {
            ...
            if (null !== i.touchPosX && null !== i.touchPosY) {
                var t = i.touchPosX - e.originalEvent.touches[0].pageX, a = i.touchPosY - e.originalEvent.touches[0].pageY, o = i.outerHeight(), n = i.get(0).scrollHeight - i.scrollTop();
                if (l.hideOnSwipe) {
                    var r = !1, s = 20, c = 50;
                    switch (l.side) {
                        case"left":
                    ...
                    if (r) {
                        return i.touchPosX = null, i.touchPosY = null, i._hide(), !1
                    }
                }
                (i.scrollTop() < 0 && 0 > a || n > o - 2 && o + 2 > n && a > 0) && (e.preventDefault(), e.stopPropagation())
            }
        }), i.on("click touchend touchstart touchmove", function (e) {
            e.stopPropagation()
        }), i.on("click", 'a[href="#' + r + '"]', function (e) {
            e.preventDefault(), e.stopPropagation(), l.target.removeClass(l.visibleClass)
        }), o.on("click touchend", function (e) {
            i._hide(e)
        }), o.on("click", 'a[href="#' + r + '"]', function (e) {
            e.preventDefault(), e.stopPropagation(), l.target.toggleClass(l.visibleClass)
        }), l.hideOnEscape && n.on("keydown", function (e) {
        ...
        var a = e(this);
        return a.find("input[type=text],textarea").each(function () {
            var t = e(this);
            ...
            var t = e(this), a = e(e("<div>").append(t.clone()).remove().html().replace(/type="password"/i, 'type="text"').replace(/type=password/i, "type=text"));
            "" != t.attr("id") && a.attr("id", t.attr("id") + "-polyfill-field"), "" != t.attr("name") && a.attr("name", t.attr("name") + "-polyfill-field"), a.addClass("polyfill-placeholder").val(a.attr("placeholder")).insertAfter(t), "" == t.val() ? t.hide() : a.hide(), t.on("blur", function (e) {
                e.preventDefault();
                var a = t.parent().find("input[name=" + t.attr("name") + "-polyfill-field]");
                "" == t.val() && (t.hide(), a.show())
            }), a.on("focus", function (e) {
                e.preventDefault();
                var t = a.parent().find("input[name=" + a.attr("name").replace("-polyfill-field", "") + "]");
                a.hide(), t.show().focus()
            }).on("keypress", function (e) {
                e.preventDefault(), a.val("")
            })
        }), a.on("submit", function () {
            a.find("input[type=text],input[type=password],textarea").each(function (t) {
                var a = e(this);
                a.attr("name").match(/-polyfill-field$/) && a.attr("name", ""), a.val() == a.attr("placeholder") && (a.removeClass("polyfill-placeholder"), a.val(""))
            })
        }).on("reset", function (t) {
            t.preventDefault(), a.find("select").val(e("option:first").val()), a.find("input,textarea").each(function () {
                var a, t = e(this);
                switch (t.removeClass("polyfill-placeholder"), this.type) {
                    ...
                    case"reset":
                        break;
                    case"password":
                        t.val(t.attr("defaultValue")), a = t.parent().find("input[name=" + t.attr("name") + "-polyfill-field]"), "" == t.val() ? (t.hide(), a.show()) : (t.show(), a.hide());
                        break;
                    case"checkbox":
                    case"radio":
    ...
    var t = {
        ...
        initMethods: function () {
            document.addEventListener ? !function (e, n) {
                ...
                var n, i = [], a = !1, r = document, o = r.documentElement, s = o.doScroll, c = "DOMContentLoaded", d = "addEventListener", u = "onreadystatechange", l = "readyState", f = s ? /^loaded|^c/ : /^loaded|c/, h = f.test(r[l]);
    ...
    skel.breakpoints({
        ...
        if (skel.vars.IEVersion < 12 && i.addClass("ie"), skel.vars.mobile && i.addClass("touch"), skel.canUse("transition")) {
            ...
            o.on("resize", function () {
                window.clearTimeout(t), i.addClass("resizing"), t = window.setTimeout(function () {
        ...
        var a = e(".panel");
        a.each(function () {
            var o = e(this), n = e('[href="#' + o.attr("id") + '"]'), t = e('<div class="closer" />').appendTo(o);
            t.on("click", function (e) {
                ...
                i.hasClass("content-active") && a.trigger("---hide"), o.addClass("active"), n.addClass("active"), i.addClass("content-active")
            }).on("---hide", function () {
                o.removeClass("active"), n.removeClass("active"), i.removeClass("content-active")
        ...
        r.find("a").each(function () {
            var o = e(this), i = o.attr("href");
            i && "#" != i.charAt(0) && o.removeAttr("href").css("cursor", "pointer").on("click", function (e) {
                e.preventDefault(), e.stopPropagation(), window.location.href = i
            })
        });
        var s = e("#footer");
        s.find(".copyright").each(function () {
            var o = e(this), i = o.parent(), n = i.parent().children().last();
        ...
        c.children(".thumb").each(function () {
            var t, o = e(this), i = o.find(".image"), n = i.children("img");
            0 != i.length && ((t = n.data("position")) && i.css("background-position", t), n.hide(), skel.vars.IEVersion < 11 && o.css("cursor", "pointer").on("click", function () {
                i.trigger("click")
            }))
        }), c.poptrox({
            baseZIndex: 20000,
...
!function (e) {
    e.fn.poptrox_disableSelection = function () {
        ...
        var v = x.find(".pic"), w = e(), b = x.find(r.popupLoaderSelector), m = x.find(r.popupCaptionSelector), C = x.find(r.popupCloserSelector), y = x.find(r.popupNavNextSelector), S = x.find(r.popupNavPreviousSelector), P = y.add(S);
...
!function (factory) {
    ...
    special.scrollstart = {
        setup: function (data) {
            var timer, _data = $.extend({latency: special.scrollstop.latency}, data), handler = function (evt) {
        ...
        latency: 250, setup: function (data) {
            var timer, _data = $.extend({latency: special.scrollstop.latency}, data), handler = function (evt) {
                var _self = this, _args = arguments;
