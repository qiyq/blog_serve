...
!function (a) {
    ...
    f = function () {
        ...
        return a.isPlainObject(b) || (b = {}), a.each(e, function (g, h) {
            ...
            var e = this, f = h.eq(c), i = f.attr("src"), k = f.attr("data-" + b.data_attribute), l = b.url_rewriter_fn == g ? k : b.url_rewriter_fn.call(e, f, k), n = f.attr("data-" + b.data_srcset_attribute), o = f.is("img");
